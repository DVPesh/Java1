...
public class Task4 {
    private static final int SIZE=8; //размер игрового поля
    private static final int DOTS_TO_WIN=5; //длина выигрышной комбинации
    ...
    ******************************************************/
    private static boolean isAiBlocksGamerWin(){
    ...
    *******************************************************/
    private static boolean isAiMakesWinMove(){
        for(int i=0;i<SIZE;i++){
            for(int j=0;j<SIZE;j++){
                if(map[i][j]==EMPTY_SIGN){
                    map[i][j]=AI_SIGN;
